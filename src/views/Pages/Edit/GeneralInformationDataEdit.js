...
function GeneralInformationDataEdit(props) {
  ...
  data.map((item)=>{
    ...
    professional_membership_name=item.professional_membership_name,
  ...
  function funedit() {
    ...
    if(document.getElementById("MOOC").value.length !== 0){  
      ...
      params.append("mqua", mother_occupation);
    }   
    ...
    if(document.getElementById("MEMBNAME").value.length !== 0){  
      ...
      params.append("membn", professional_membership_name);
    } 
                ...
                <Flex direction="column">
                  <FormControl>
                    <Input
                      ...
                      fontSize="sm"
                      type="text"
                      placeholder={professional_membership_name}
                    />
                  </FormControl>
                </Flex>
              </Flex>
